          ...
          <div className="container">
            <div className="row align-items-center">
              ...
              <div className="col-md-12 col-lg-4 order-lg-1" data-aos="fade-up">
                <h2 style={{ fontSize: '40px' }} className="heading">
                  Welcome!
                </h2>
                <p style={{ color: '#008080' }} className="mb-4">
                  Become a Host in 3 easy steps.
                </p>
                <p>Please join us. We will help you through every step of the process.</p>
                <p>
                  <Link to={'/location'} className="bg-cyan px-6 py-3 rounded text-white font-bold inline-block my-2 ">
                    Get started
                  </Link>{' '}
