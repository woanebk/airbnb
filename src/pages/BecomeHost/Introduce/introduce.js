...
export class introduce extends Component {
    render() {
        ...
        <div className="container">
          <div style={{marginTop:"35px"}} className="row align-items-center">
            ...
            <div className="col-md-12 col-lg-4 order-lg-1" data-aos="fade-up">
              ...
              <p className="mb-4">Become a Host in 3 easy steps.</p>
              <p>Please join us. We will help you through every step of the process.</p>
              <p><Link to={"/location"} className="btn btn-primary text-white py-2 mr-3">Get started</Link> <span className="mr-3 font-family-serif"><em>or</em></span> <a href="https://vimeo.com/channels/staffpicks/93951774" data-fancybox className="text-uppercase letter-spacing-1">Back</a></p>
