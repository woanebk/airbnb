...
export class describe extends Component {
    render() {
        return (<div>
             ...
             <div style={{marginTop:"15px"}} className="col-8">
                   <img style={{width:"130px", height:"40px", marginTop:"5px", marginLeft:"100px"}} src="data:image/png;base64,"></img>
                   	<a style={{ marginBottom:"20px", marginLeft:"20px", marginTop:"20px"}} href='#' class='active'>Describle</a>
              </div>
             ...
             <div className="container-fluid">
                <div className="row">
                    <div style={{height:"580px"}} className="col-md-6 video mid">
                        <video style={{width:"640px", height:"570px", objectFit:"cover"}}   autoPlay muted loop>
             ...
             <h3>What amenities do you offer? &nbsp;  What spaces can guests use?</h3>
             <h3></h3>
                    ...
                    <div className="col-md-6">
                        <div style={{height:"480px"}} className="row">
                            <div style={{width:"580px", height:"450px"}} className="describe">
                                <h4 style={{ color:"#ff385c", marginLeft:"30px"}}>What amenities do you offer?</h4>
                                <h5 style={{ marginLeft:"30px"}} >These are just the amenities guests usually expect, but you can add even more after you publish.</h5>
                                <div style={{marginLeft:"30px"}} className=" body-checkbox col">
        <ul style={{height:"175px"}}  className="ks-cboxtags">
        ...
        <h4 style={{ color:"#ff385c"}}>What spaces can guests use??</h4>
        <div style={{marginLeft:"-332px"}} className=" body-checkbox col">
        <ul style={{height:"120px", width:"580px"}}  className="ks-cboxtags">
          ...
          <li><input type="checkbox" id="checkboxFifteen" defaultValue="Firefly" /><label htmlFor="checkboxFifteen">Firefly</label></li>
                        ...
                        <div className="col-4">
                        <Link style={{marginLeft:"30px"}} to="/contact" class='btn btn-primary'>Next  &nbsp; &nbsp; <i class="fas fa-arrow-right"></i></Link>
                        </div>
                        </div>
                    </div>
