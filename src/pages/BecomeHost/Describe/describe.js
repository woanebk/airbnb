        ...
        <div className="row nav" style={{ height: '80px', width: '100%' }}>
          <div style={{ marginTop: '20px' }} className="col-8">
            <div className="row">
              ...
              ></img>
              <p style={{ fontSize: '19px', marginBottom: '10px', marginTop: '8px' }} className="col-1 active">
                Describe
              </p>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col-md-6">
            <div className="app">
              ...
              <div>
                ...
                <div
                  style={{ height: '395px', background: '#ADD8E6', marginLeft: '60px', width: '591px' }}
                  className="result"
                >
          ...
          <div className="col-md-6">
            <div className="">
              <div style={{ height: '480px' }}>
                <div style={{ width: '550px', height: '450px' }} className="describe">
                  ...
                  <h5 style={{ marginLeft: '30px', fontSize: '16px', marginTop: '10px' }}>
                  ...
                  <div style={{ marginLeft: '30px' }} className=" body-checkbox col">
                    <ul style={{ marginTop: '10px', height: '175px' }} className="ks-cboxtags ul">
                      ...
                      <li>
                        <input type="checkbox" id="checkboxNine" defaultValue="Princess Celestia" />
                      ...
                      <li>
                        <input type="checkbox" id="checkboxThirteen" defaultValue="Baby Moondancer" />
                  ...
                  <div style={{ marginTop: '200px', marginLeft: '30px' }} className="row">
                    <h4 style={{ color: '#008f94', fontSize: '19px', fontWeight: 'bold', marginTop: '10px' }}>
            ...
            <div style={{ marginTop: '-2px', marginLeft: '-24px' }} className="row line">
              <div style={{ width: '420px' }} className="row line2"></div>
            </div>
            <div style={{ height: '100px', marginTop: '25px' }} className="row">
              <div className="col-8">
                <a
                  style={{ fontSize: '18px', marginLeft: '30px', marginTop: '15px !important' }}
              ...
              <div className="col-4">
                <Link style={{ marginLeft: '30px', marginTop: '-10px' }} to="/contact" class="btn btn-primary">
