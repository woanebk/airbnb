    ...
    <body class="antialiased text-gray-800" style={{ margin: 0 }}>
      <div class="relative bg-img bg-no-repeat bg-cover lg:bg-center p-6 bg-top-right">
        ...
        <a href="/">
          <h1>
            ...
            <svg viewBox="0 0 1000 1000" role="presentation" aria-hidden="true" focusable="false" style={{ height: 32, width: 32, display: 'block', fill: '#ffffff' }}><title>AirBnb</title><path d="m499.3 736.7c-51-64-81-120.1-91-168.1-10-39-6-70 11-93 18-27 45-40 80-40s62 13 80 40c17 23 21 54 11 93-11 49-41 105-91 168.1zm362.2 43c-7 47-39 86-83 105-85 37-169.1-22-241.1-102 119.1-149.1 141.1-265.1 90-340.2-30-43-73-64-128.1-64-111 0-172.1 94-148.1 203.1 14 59 51 126.1 110 201.1-37 41-72 70-103 88-24 13-47 21-69 23-101 15-180.1-83-144.1-184.1 5-13 15-37 32-74l1-2c55-120.1 122.1-256.1 199.1-407.2l2-5 22-42c17-31 24-45 51-62 13-8 29-12 47-12 36 0 64 21 76 38 6 9 13 21 22 36l21 41 3 6c77 151.1 144.1 287.1 199.1 407.2l1 1 20 46 12 29c9.2 23.1 11.2 46.1 8.2 70.1zm46-90.1c-7-22-19-48-34-79v-1c-71-151.1-137.1-287.1-200.1-409.2l-4-6c-45-92-77-147.1-170.1-147.1-92 0-131.1 64-171.1 147.1l-3 6c-63 122.1-129.1 258.1-200.1 409.2v2l-21 46c-8 19-12 29-13 32-51 140.1 54 263.1 181.1 263.1 1 0 5 0 10-1h14c66-8 134.1-50 203.1-125.1 69 75 137.1 117.1 203.1 125.1h14c5 1 9 1 10 1 127.1.1 232.1-123 181.1-263.1z"></path></svg>
          </h1>
        </a>
                            ...
                            <div className="form-group">
                              ...
                              <div className="app1">
                                ...
                                <div style={{ marginTop: "5px" }} className="button__wrapper">
                                  ...
                                  <h1 style={{ fontSize: "20px", fontWeight: "bold", marginLeft: "-10px" }} className={count > 0 ? "positive" : count < 0 ? "negative" : null}>
                                    {count}
                                  </h1>
                                  <button style={{ marginLeft: "-10px" }} onClick={increase}>+</button>
                                </div>
                              </div>
      ...
      <div class="max-w-5xl mx-auto lg:py-16 py-12 lg:px-0 px-4">
        ...
        <div class="flex lg:items-center items-start">
          ...
          <p class="pl-2">Viet Nam homes were <strong>rated 4.8 out of 5 stars</strong> with <strong>42,500,000+ reviews</strong></p>
        </div>
        ...
        <section class="flex items-start flex-wrap justify-between lg:my-10 my-6">
          ...
          <article class="lg:w-1/3 w-full lg:pr-4 lg:mb-0 mb-6">
            ...
            <p class="text-gray-700 font-light text-sm leading-snug">What a wonderful little cottage! More spacious and adorable than the pictures show. We never met our hosts, but we felt welcomed and... </p>
        ...
        <section class="flex items-start flex-wrap justify-between lg:my-8 my-6">
          <a href="#" class="lg:w-1/4 md:w-1/2 w-full lg:pr-2 md:pr-2 lg:mb-0 mb-6">
            ...
            <p class="uppercase text-gray-600 text-xs font-bold pt-2">Entire House <span aria-hidden="true">•</span> Joshua Tree</p>
            ...
            <div class="flex items-center">
              <svg class="fill-current w-2 h-2 text-cyan mr-1" viewBox="0 0 1000 1000" xmlns="http://www.w3.org/2000/svg"><path d="M972 380c9 28 2 50-20 67L725 619l87 280c11 39-18 75-54 75-12 0-23-4-33-12L499 790 273 962a58 58 0 0 1-78-12 50 50 0 0 1-8-51l86-278L46 447c-21-17-28-39-19-67 8-24 29-40 52-40h280l87-279c7-23 28-39 52-39 25 0 47 17 54 41l87 277h280c24 0 45 16 53 40z" /></svg>
              <svg class="fill-current w-2 h-2 text-cyan mr-1" viewBox="0 0 1000 1000" xmlns="http://www.w3.org/2000/svg"><path d="M972 380c9 28 2 50-20 67L725 619l87 280c11 39-18 75-54 75-12 0-23-4-33-12L499 790 273 962a58 58 0 0 1-78-12 50 50 0 0 1-8-51l86-278L46 447c-21-17-28-39-19-67 8-24 29-40 52-40h280l87-279c7-23 28-39 52-39 25 0 47 17 54 41l87 277h280c24 0 45 16 53 40z" /></svg>
              <svg class="fill-current w-2 h-2 text-cyan mr-1" viewBox="0 0 1000 1000" xmlns="http://www.w3.org/2000/svg"><path d="M972 380c9 28 2 50-20 67L725 619l87 280c11 39-18 75-54 75-12 0-23-4-33-12L499 790 273 962a58 58 0 0 1-78-12 50 50 0 0 1-8-51l86-278L46 447c-21-17-28-39-19-67 8-24 29-40 52-40h280l87-279c7-23 28-39 52-39 25 0 47 17 54 41l87 277h280c24 0 45 16 53 40z" /></svg>
              <svg class="fill-current w-2 h-2 text-cyan mr-1" viewBox="0 0 1000 1000" xmlns="http://www.w3.org/2000/svg"><path d="M972 380c9 28 2 50-20 67L725 619l87 280c11 39-18 75-54 75-12 0-23-4-33-12L499 790 273 962a58 58 0 0 1-78-12 50 50 0 0 1-8-51l86-278L46 447c-21-17-28-39-19-67 8-24 29-40 52-40h280l87-279c7-23 28-39 52-39 25 0 47 17 54 41l87 277h280c24 0 45 16 53 40z" /></svg>
              <svg class="fill-current w-2 h-2 text-cyan mr-1" viewBox="0 0 1000 1000" xmlns="http://www.w3.org/2000/svg"><path d="M972 380c9 28 2 50-20 67L725 619l87 280c11 39-18 75-54 75-12 0-23-4-33-12L499 790 273 962a58 58 0 0 1-78-12 50 50 0 0 1-8-51l86-278L46 447c-21-17-28-39-19-67 8-24 29-40 52-40h280l87-279c7-23 28-39 52-39 25 0 47 17 54 41l87 277h280c24 0 45 16 53 40z" /></svg>
              <p class="text-xs text-gray-600">467 <span aria-hidden>•</span> Superhost</p>
            </div>
          </a>
          <a href="#" class="lg:w-1/4 md:w-1/2 w-full lg:px-1 md:px-1 lg:mb-0 mb-6">
            <img src={just_booked_2} class="object-cover w-full" />
            <p class="uppercase text-gray-600 text-xs font-bold pt-2">Dome house <span aria-hidden="true">•</span> Aptos</p>
            ...
            <div class="flex items-center">
              ...
              <svg class="fill-current w-2 h-2 text-cyan mr-1" viewBox="0 0 1000 1000" xmlns="http://www.w3.org/2000/svg"><path d="M972 380c9 28 2 50-20 67L725 619l87 280c11 39-18 75-54 75-12 0-23-4-33-12L499 790 273 962a58 58 0 0 1-78-12 50 50 0 0 1-8-51l86-278L46 447c-21-17-28-39-19-67 8-24 29-40 52-40h280l87-279c7-23 28-39 52-39 25 0 47 17 54 41l87 277h280c24 0 45 16 53 40z" /></svg>
              <svg class="fill-current w-2 h-2 text-cyan mr-1" viewBox="0 0 1000 1000" xmlns="http://www.w3.org/2000/svg"><path d="M972 380c9 28 2 50-20 67L725 619l87 280c11 39-18 75-54 75-12 0-23-4-33-12L499 790 273 962a58 58 0 0 1-78-12 50 50 0 0 1-8-51l86-278L46 447c-21-17-28-39-19-67 8-24 29-40 52-40h280l87-279c7-23 28-39 52-39 25 0 47 17 54 41l87 277h280c24 0 45 16 53 40z" /></svg>
              <p class="text-xs text-gray-600">1392 <span aria-hidden>•</span> Superhost</p>
            </div>
          </a>
          <a href="#" class="lg:w-1/4 md:w-1/2 w-full lg:px-1 md:px-1 lg:mb-0 mb-6">
            <img src={just_booked_3} class="object-cover w-full" />
            <p class="uppercase text-gray-600 text-xs font-bold pt-2 leading-snug">Earth house <span aria-hidden="true">•</span> Orondo</p>
            ...
            <div class="flex items-center">
              ...
              <svg class="fill-current w-2 h-2 text-cyan mr-1" viewBox="0 0 1000 1000" xmlns="http://www.w3.org/2000/svg"><path d="M972 380c9 28 2 50-20 67L725 619l87 280c11 39-18 75-54 75-12 0-23-4-33-12L499 790 273 962a58 58 0 0 1-78-12 50 50 0 0 1-8-51l86-278L46 447c-21-17-28-39-19-67 8-24 29-40 52-40h280l87-279c7-23 28-39 52-39 25 0 47 17 54 41l87 277h280c24 0 45 16 53 40z" /></svg>
              <svg class="fill-current w-2 h-2 text-cyan mr-1" viewBox="0 0 1000 1000" xmlns="http://www.w3.org/2000/svg"><path d="M972 380c9 28 2 50-20 67L725 619l87 280c11 39-18 75-54 75-12 0-23-4-33-12L499 790 273 962a58 58 0 0 1-78-12 50 50 0 0 1-8-51l86-278L46 447c-21-17-28-39-19-67 8-24 29-40 52-40h280l87-279c7-23 28-39 52-39 25 0 47 17 54 41l87 277h280c24 0 45 16 53 40z" /></svg>
              <p class="text-xs text-gray-600">552 <span aria-hidden>•</span> Superhost</p>
            </div>
          </a>
          <a href="#" class="lg:w-1/4 md:w-1/2 w-full lg:pl-2 md:pl-2">
            <img src={just_booked_4} class="object-cover w-full" />
            <p class="uppercase text-gray-600 text-xs font-bold pt-2">Entire house <span aria-hidden="true">•</span> Pioneertown</p>
