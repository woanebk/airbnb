  ...
  render() {
    return (
      ...
      <div style={{ height: '60vh', width: '100%' }}>
        ...
        >
          <AnyReactComponent lat={59.955413} lng={30.337844} text="Destination" />
        </GoogleMapReact>
      </div>
    );
  }
...
function App() {
  ...
  function OutsideAlerter(props) {
    ...
    return (
      <div ref={wrapperRef} className="quantity-dropdown-wrapper">
        {isQuantityDropDownOpened && <QuantityDropDown />}
      </div>
    );
  }
    ...
    if (title === chosenTitle)
      return (
        <div className="container-title--active">
          <p
            className="section-title title--active"
            onClick={() => {
              set_chosenTitle(title);
            }}
          >
            {title}
          </p>
      ...
      return (
        <div>
          <p
            className="section-title title--inactive"
            onClick={() => {
              set_chosenTitle(title);
            }}
          >
          ...
          <>
            ...
            <div className="host-card">
              <div className="host-profile-img">
                <div className="host-profile-verified-badge"></div>
              </div>
        ...
        return (
          <div className="reviews-section-container">
            ...
            <div className="card my-4">
                                                    <h6 className="card-header">Write a comment...</h6>
                                                    <div className="card-body">
                                                    <div style={{marginLeft:"40px", marginBottom:"-50px"}} className="stars-group row">
                  <HiStar className="react-icons-star" />
                  <HiStar className="react-icons-star" />
                  <HiStar className="react-icons-star" />
                  <HiStar className="react-icons-star" />
                  <HiStar className="react-icons-star" />
                                                    ...
                                                    <div className="form-group">
                                                        <textarea className="form-control mt-20" name="message" rows={3} data-rule="required" data-msg="Please write something for us" placeholder="Comment" defaultValue={""} />
                                                        <div className="validate" />
                                                    </div>
                                                        <button className="btn  btn_normal" >
                                                             <i className="fab fa-telegram-plane"></i>  &nbsp;  &nbsp;&nbsp; &nbsp; &nbsp; Post rating
                                                        </button>
                                                    </form>
                                                    </div>
                                                </div>
        ...
        return (
          <div className="host-details-container">
            ...
            <div className="host-description">
              ...
              <p>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Thank you for considering staying with me during your visit to Vung
                Tau. Whether you're coming for business, pleasure, or to visit family, I think you will enjoy my rooms
                and my neighborhood.
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; I've been here in Vung Tau since 2000, and I can help you figure
                out what to do and how to get around. I've travelled quite a bit and enjoy having the world come to me!
                Here are all of my listing:
                <br />
                <br />
              </p>
              <p>Home with nice garden:</p>{' '}
              <p className="link">
                {' '}
                https://www.airbnb.com/rooms/1234
                <br />
              </p>
              <p>Home with no garden: </p>
              <p className="link">
                {' '}
                https://www.airbnb.com/rooms/4321
                <br />
              </p>
              <p>Home with nothing inside:</p>
              <p className="link">
                {' '}
                https://www.airbnb.com/rooms/4567
                <br />
              </p>
  ...
  return (
    <>
      <nav
        style={{ height: '80px', background: 'white', flex: 1, alignItems: 'center' }}
        className="nav navbar navbar-expand-md navbar-light sticky-top"
      >
        <img
          style={{ width: 130, height: 40, marginTop: 20, marginLeft: 100 }}
        ...
        <div className="room-details-book">
          ...
          <div className="book-section">
            <div className="book-form">
              <div className="price-roomrating-container">
                <div className="price-priceunit-container">
                  <p style={{ marginBottom: '25px' }} className="price">
                    $125 USD
                  </p>
              ...
              <div className="checkin-checkout-container">
                <div className="temp-flex-box">{DateDisplay(checkinDate, 'Check In')}</div>
                <FiArrowRight className="react-icons-arrow-right" />
                <div className="temp-flex-box">{DateDisplay(checkinDate, 'Check Out')}</div>
              </div>
            ...
            /> */}
              ...
              <div
                className="guests-quantity-picker-container"
                onMouseDown={() => {
                  set_QuantityDropDown(!isQuantityDropDownOpened);
                }}
              >
              ...
              <div className="book-btn" onClick={() => {}}>
                <p className="book-btn-content">Book</p>
              </div>
